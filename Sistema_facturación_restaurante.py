...
def recibo():
    ...
    for comida in texto_comida:
        if comida.get() != "0":
            texto_recibo.insert(END, f"{lista_comidas[0]}\t\t{comida.get()}\t"
    ...
    for postre in texto_postre:
        if postre.get() != "0":
            texto_recibo.insert(END, f"{lista_postres[0]}\t\t{postre.get()}\t"
    ...
    for bebida in texto_bebida:
        if bebida.get() != "0":
            texto_recibo.insert(END, f"{lista_bebidas[0]}\t\t{bebida.get()}\t"
...
aplicacion.geometry("1270x700+0+0")
...
#panel bebidas
panel_bebidas = LabelFrame(panel_izquierdo, text = "Bebidas",font=("Dosis",19,"bold"),bd=1,
...
#panel postres
panel_postres = LabelFrame(panel_izquierdo, text = "Postres",font=("Dosis",19,"bold"),bd=1,
                           relief=FLAT,fg="azure4")
...
#panel recibos.
panel_recibos = Frame(panel_derecho,bd=1,relief=FLAT, bg="burlywood")
panel_recibos.pack()
...
lista_comidas = ["Spaghettis","Macarrones","Nuggets","Burger","Pollo","Pizza","Arroz","Cocido"]
lista_bebidas = ["Fanta","Agua","Vino","Vermouth","Coca-cola","Aquarius","Trina","Zumo"]
lista_postres = ["Helado","Fruta","Brownies","Flan","Mousse","Tarta","Gofres","Vica"]
